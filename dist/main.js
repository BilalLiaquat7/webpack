...
eval("const addTodo = (description) => {\r\n  const id = 0;\r\n  const todo = { description, index: id + 1, complete: false };\r\n  return todo;\r\n};\r\n\r\nmodule.exports = addTodo;\r\n\n\n//# sourceURL=webpack://webpack/./src/addTodo.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Addtodo: () => (/* binding */ Addtodo),\n/* harmony export */   clearCompletedTodos: () => (/* binding */ clearCompletedTodos),\n/* harmony export */   completed: () => (/* binding */ completed),\n/* harmony export */   updateTodo: () => (/* binding */ updateTodo)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n/* harmony import */ var _addTodo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addTodo.js */ \"./src/addTodo.js\");\n/* harmony import */ var _addTodo_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_addTodo_js__WEBPACK_IMPORTED_MODULE_1__);\n\r\n\r\n\r\nconst Addtodo = (description) => {\r\n  const todo = (0,_addTodo_js__WEBPACK_IMPORTED_MODULE_1__.addTodo)(description);\r\n  todo.index = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.CreateandGet)().length + 1;\r\n  _index_js__WEBPACK_IMPORTED_MODULE_0__.todoTasks.push(todo);\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.storeData)(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoTasks);\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.displayTodoList)();\r\n};\r\n\r\nconst updateTodo = (e, index) => {\r\n  if (e.keyCode === 13) {\r\n    const updatetodo = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.CreateandGet)().map((item) => {\r\n      if (item.index === index) {\r\n        item.description = e.target.textContent;\r\n      }\r\n      return item;\r\n    });\r\n    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.storeData)(updatetodo);\r\n    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.displayTodoList)();\r\n  }\r\n};\r\n\r\nconst completed = (index) => {\r\n  const updatetodo = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.CreateandGet)().map((item) => {\r\n    if (item.index === index && item.complete === true) {\r\n      item.complete = false;\r\n    } else if (item.index === index) {\r\n      item.complete = true;\r\n    }\r\n    return item;\r\n  });\r\n  console.log(updatetodo);\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.storeData)(updatetodo);\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.displayTodoList)();\r\n};\r\n\r\nconst clearCompletedTodos = () => {\r\n  const updatetodo = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.CreateandGet)().filter((item) => item.complete === false);\r\n  updatetodo.forEach((element, index) => {\r\n    element.index = index + 1;\r\n  });\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.storeData)(updatetodo);\r\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.displayTodoList)();\r\n};\r\n\n\n//# sourceURL=webpack://webpack/./src/input.js?");
